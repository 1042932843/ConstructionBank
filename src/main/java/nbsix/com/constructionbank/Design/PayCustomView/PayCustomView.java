package nbsix.com.constructionbank.Design.PayCustomView;
...
/**
 * Name: CustomStatusView
 * Author: Dusky
 * QQ: 1042932843
 * Comment: //收款后的完成和失败动画
 * Date: 2017-09-15 14:44
 */
public class PayCustomView extends View {
    ...
    public PayCustomView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray array = context.getTheme().obtainStyledAttributes(attrs, R.styleable.PayCustomView, defStyleAttr, 0);
        progressColor = array.getColor(R.styleable.PayCustomView_progress_color, ContextCompat.getColor(context, R.color.colorPrimary));
        loadSuccessColor = array.getColor(R.styleable.PayCustomView_load_success_color, ContextCompat.getColor(context, R.color.colorPrimary));
        loadFailureColor = array.getColor(R.styleable.PayCustomView_load_failure_color, ContextCompat.getColor(context, R.color.red));
        progressWidth = array.getDimension(R.styleable.PayCustomView_progress_width, 6);
        progressRadius = array.getDimension(R.styleable.PayCustomView_progress_radius, 100);
        array.recycle();
