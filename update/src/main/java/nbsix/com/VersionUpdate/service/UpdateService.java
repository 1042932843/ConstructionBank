...
public class UpdateService extends Service {
    ...
    private class DownLoadBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Config.ACTION_START)) {
                ...
                FileBean fileBean = (FileBean) intent.getSerializableExtra("FileBean");
                //开始下载
                DownloadTask downloadTask = new DownloadTask(UpdateService.this, fileBean, 3);
                ...
                if (isDownLoading) {
                    ...
                    startIntent.setAction(UpdateService.ACTION_PAUSE);
    ...
    private void installPage(FileBean filebean) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Log.w("dsy","pageName"+getPackageName());
